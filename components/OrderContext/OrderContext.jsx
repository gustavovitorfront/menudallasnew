...
function OrderContext({
  ...
  const handleOrderFinally = async () => {
    ...
    try {
      ...
      dt.valor_total = total + parseFloat(dt.valor_taxa ? dt.valor_taxa : 0) - cupomDesconto;
  ...
  console.debug("sadadads", data.user_id);
                ...
                >
                  <Flex>
                    <Image
                      onClick={() =>
                        router.push(
                          `/produto/${slugify(item.descricao, {
                            lower: true,
                          })}?g=${item.id_grupo}&p=${item.id}`
                        )
                      }
                      ...
                      <Popover placement="auto">
                        ...
                        <Portal>
                          <PopoverContent bg="white" ml={["20px", "auto"]}>
                            ...
                            <PopoverHeader fontSize="16px" fontWeight={600}>
                              Detalhes
                            </PopoverHeader>
                            <PopoverBody>
                              ...
                              >
                                ...
                                {item.observacao_item && (
                                  ...
                                  >
                                    <b>Observações:</b> {item.observacao_item}
                                  </Text>
                                )}

                                <Flex
                                  mt="5px"
                                  className="detalhesRodape"
                                  w="100%"
                                  justifyContent="space-between"
                                  fontSize="sm"
                                  fontWeight={500}
                  ...
                  >
                    <Button
                      ...
                      p={["0px", ""]}
                      ml={["-5px", ""]}
                      onClick={() => updateToCard(key, item.quantidade - 1)}
                    >
